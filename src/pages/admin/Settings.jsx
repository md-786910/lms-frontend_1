          ...
          <div className="grid grid-cols-12 items-center gap-4">
            <div className="col-span-12 md:col-span-8 space-y-2">
              <div className="flex items-center gap-3">
                <h1 className="text-3xl font-bold font-montserrat text-[#FFFFFF]">System Settings</h1>
              </div>
        ...
        <div className="rounded-md border border-slate-200 bg-white shadow-[0_18px_60px_rgba(15,23,42,0.08)] transition-shadow duration-300 will-change-transform">
          <div className="flex flex-col gap-2 border-b border-slate-100 px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="font-medium text-sm font-montserrat text-[#131313]">
                ...
                {settingTabs?.map((tab) => {
                  ...
                  return (
                    <NavLink
                      to={tab.link}
                      key={tab.id}
                      className={`group inline-flex items-center gap-3 rounded-full px-4 py-2 text-base font-medium text-slate-700 shadow-sm transition font-montserrat duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 ${
                        isActive
                          ? "border-slate-900 bg-slate-900 text-white shadow-lg shadow-slate-900/30 font-montserrat"
                          : "border border-[#e2e8f0] bg-white text-slate-700 hover:border-emerald-100 hover:bg-slate-50 font-montserrat"
                      }`}
                    >
                      <span
