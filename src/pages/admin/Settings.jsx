...
const Settings = () => {
  ...
  return (
    <div className="space-y-8 mb-10">
      {/* Hero / Page header */}
      <div className="relative overflow-hidden rounded-[28px] border border-slate-200 bg-gradient-to-r from-slate-900 via-slate-800 to-primary shadow-[0_24px_80px_rgba(15,23,42,0.22)] px-6 py-8 sm:px-10 sm:py-12 text-white">
        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-4 max-w-2xl">
            <p className="text-[11px] font-semibold uppercase tracking-[0.45em] text-slate-200/80">
              Control Center
            </p>
      ...
      {/* Navigation */}
      <div className="rounded-[28px] border border-slate-200 bg-white shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
            ...
            {settingTabs?.map((tab) => {
              ...
              return (
                <NavLink
                  to={tab.link}
                  key={tab.id}
                  className={`group relative flex items-start gap-4 rounded-md border px-4 py-4 transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 ${
                    isActive
