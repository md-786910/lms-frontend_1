      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-6 text-white">
        <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-white text-blue-700 font-semibold px-4 py-2 rounded-md hover:bg-blue-100 shadow h-10"
            >
              View Holidays
            </button>
          </div>
              ...
              <div className="space-y-4">
                {upcomingEvents.map((event, index) => (
                  ...
                  >
                    ...
                    <div
                      className={`px-2 py-1 rounded text-xs font-medium ${event.type === "meeting"
