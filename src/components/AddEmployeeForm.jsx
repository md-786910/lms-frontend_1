      ...
      <CardContent className="flex-1 overflow-y-auto px-6 mt-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="firstName">First Name <span className="text-rose-500 font-graphik font-medium text-sm">*</span></Label>
              <Input
                id="firstName"
                name="firstName"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="email">Email Address <span className="text-rose-500 font-graphik font-medium text-sm">*</span></Label>
              <Input
                id="email"
                name="email"
                type="email"
            ...
            <div>
              <Label htmlFor="phone">Phone Number <span className="text-rose-500 font-graphik font-medium text-sm">*</span></Label>
              <Input
                id="phone"
                name="phone"
                value={values.phone}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="gender">Gender <span className="text-rose-500 font-graphik font-medium text-sm">*</span></Label>
              <Select
                value={values.gender}
                onValueChange={(val) =>
            ...
            <div>
              <Label htmlFor="maritalStatus">Marital Status <span className="text-rose-500 font-graphik font-medium text-sm">*</span></Label>
              <Select
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="department">Department <span className="text-rose-500 font-graphik font-medium text-sm">*</span></Label>
              <Select
            ...
            <div>
              <Label htmlFor="designation">Designation <span className="text-rose-500 font-graphik font-medium text-sm">*</span></Label>
              <Select
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2 flex flex-col">
              <Label htmlFor="dateOfBirth">Date of Birth <span className="text-rose-500 font-graphik font-medium text-sm">*</span></Label>
            ...
            <div className="space-y-2 flex flex-col">
              <Label htmlFor="dateOfJoining">Date of Joining <span className="text-rose-500 font-graphik font-medium text-sm">*</span></Label>
              <Popover
